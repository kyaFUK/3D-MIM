...
class InputHandle:
    ...
    def input_batch(self):
        ...
        input_batch = np.transpose(input_batch,(0,1,3,4,5,2))
        for i in range(self.current_batch_size):
            ...
            data_slice = np.transpose(data_slice,(0,2,3,4,1))
    ...
    def output_batch(self):
        ...
        if self.is_output_sequence:
            if (1, 3) == self.data['dims'].shape or (1, 4) == self.data['dims'].shape:
        ...
        #swap axes
        output_batch = np.transpose(output_batch, [0,1,3,4,5,2])
